...
public class ModFoodProperties
{
    ...
    public static final FoodProperties CRIMSON_BLUE_BERRIES = new FoodProperties.Builder().nutrition(3).saturationModifier(0.55f).fast().build();

    public static final FoodProperties WHITE_CARROT = new FoodProperties.Builder().nutrition(4).saturationModifier(0.35f).build();

    public static final FoodProperties GLISTERING_CARROT = new FoodProperties.Builder().nutrition(7).saturationModifier(0.857f)
