...
public class ImpurifierBlockScreen extends AbstractContainerScreen<ImpurifierBlockMenu> {
    ...
    private static final ResourceLocation FLAME_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(TesterMod.MOD_ID, "textures/gui/impurifier_progress.png");

    public ImpurifierBlockScreen(ImpurifierBlockMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
