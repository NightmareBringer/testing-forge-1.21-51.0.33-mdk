...
public class PurifierBlockMenu extends AbstractContainerMenu {
    ...
    public PurifierBlockMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public PurifierBlockMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.PURIFIER_BLOCK_MENU.get(), pContainerId);
        this.blockEntity = ((PurifierBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.PURIFIER_BLOCK.get());
    }
