...
public class ModSounds {
    ...
    public static final Supplier<SoundEvent> CONSOLE_CLICK = registerSoundEvent("console_click");
    public static final Supplier<SoundEvent> CORE_HUM = registerSoundEvent("core_hum");
